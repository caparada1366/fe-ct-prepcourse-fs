...
function colors(color) {
   ...
   // Tu código:
   var cest = "This is ";
   if (color === "blue" || color === "red" || color === "green" || color === "orange") return cest + color;
...
function esPrimo(num) {
   ...
   // Tu código:
   var respuesta = true;
   if(num <= 1) respuesta = false;
   else {
      for(var i= 2; (i <= num && respuesta == true) ; i++){
         if(i != num && num % i === 0) respuesta = false; 
...
function tieneTresDigitos(num) {
   ...
   console.log(numCadena.length);

   if(numCadena.length === 3) return true;
